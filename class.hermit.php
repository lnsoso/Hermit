...
class hermit{
	public function __construct(){
		...
		$this->admin_dir = site_url('/wp-admin/options-general.php?page=class.hermit.php');
	...
	public function shortcode($atts, $content=null){
		return '<!--Hermit for wordpress v'.VERSION.' start--><div class="hermit" songs="'.$content.'"><div class="hermit-box"><div class="hermit-controls"><div class="hermit-button"></div><div class="hermit-detail">单击鼠标左键播放或暂停。</div><div class="hermit-duration"></div><div class="hermit-listbutton"></div></div><div class="hermit-prosess"><div class="hermit-loaded"></div><div class="hermit-prosess-bar"><div class="hermit-prosess-after"></div></div></div></div><div class="hermit-list"></div></div><!--Hermit for wordpress v'.VERSION.' end-->';
	}
						...
						<tr valign="top">
							...
							<td>
								<ul>
									<li>
										<b>单曲：</b><br /><br />
										<p><img src="<?php echo $this->base_dir;?>/assets/images/screenshot1.png" /></p>							
									</li>
									<li>
										<b>专辑：</b><br />
										<p><img src="<?php echo $this->base_dir;?>/assets/images/screenshot2.png" /></p>
									</li>
								</ul>
							</td>
						</tr>
